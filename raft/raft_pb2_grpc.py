...
class RaftServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RequestVote = channel.unary_unary(
                '/raftapp.RaftService/RequestVote',
...
def add_RaftServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'raftapp.RaftService', rpc_method_handlers)
...
class RaftService(object):
    ...
    def RequestVote(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/raftapp.RaftService/RequestVote',
    ...
    def AppendEntries(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/raftapp.RaftService/AppendEntries',
    ...
    def SubmitOperation(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/raftapp.RaftService/SubmitOperation',
